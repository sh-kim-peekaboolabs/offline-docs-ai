...
export const LocalProcessingCard = ({
    className,
}: {
    className?: string;
}) => {
...
const securityWords = ["CONFIDENTIAL", "RESTRICTED", "PRIVATE", "SECRET", "LOCAL", "OFFLINE", "SECURE", "ENCRYPTED", "NO_CLOUD", "DATA_PROTECTED", "GDPR_COMPLIANT", "AES_256", "ZERO_KNOWLEDGE", "TOP_SECRET", "INTERNAL_USE_ONLY"];
