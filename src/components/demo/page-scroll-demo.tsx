            ...
            {!isComplete ? (
              ...
              >
                <div className="flex items-center gap-2 justify-center mb-1">
                  ...
                  <span className="text-sm font-semibold text-gray-900">All pages indexed</span>
                </div>
                <p className="text-center text-xs text-gray-400">
                  Ready to search across<br />{targetPages.toLocaleString()} pages
                </p>
              </motion.div>
            )}
          </AnimatePresence>
