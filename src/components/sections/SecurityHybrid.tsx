            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-[#111] mb-6">
                        금융권 수준의 보안,<br className="sm:hidden" /> 문서는 PC 밖으로 나가지 않습니다.
                    </h2>
                    <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-6">
                        로컬독스는 문서 저장(Local)과 답변 생성(Cloud)을 엄격하게 분리하여<br className="hidden sm:block" />
                        보안과 성능을 동시에 잡았습니다.
                    </p>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    {/* Feature 1 */}
                    <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 text-center hover:shadow-lg transition-shadow duration-300">
                        <div className="w-14 h-14 mx-auto bg-white rounded-xl shadow-sm border border-gray-200 flex items-center justify-center mb-6">
                            <Database className="w-7 h-7 text-gray-700" />
                        </div>
                        <h3 className="text-xl font-bold text-[#111] mb-3">문서 원본 100% 로컬 저장</h3>
                        <p className="text-gray-600 leading-relaxed">
                            당신의 파일은 당신의 하드디스크에만 존재합니다.<br />
                            클라우드로 파일이 업로드되지 않습니다.
                        </p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 text-center hover:shadow-lg transition-shadow duration-300">
                        ...
                        <h3 className="text-xl font-bold text-[#111] mb-3">최소 전송 & 즉시 삭제</h3>
                        <p className="text-gray-600 leading-relaxed">
                            답변에 필요한 몇 문장만 암호화되어 전송되며,<br />
                            답변 직후 즉시 삭제됩니다.
                        </p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 text-center hover:shadow-lg transition-shadow duration-300">
                        ...
                        <h3 className="text-xl font-bold text-[#111] mb-3">학습 금지 (Zero Retention)</h3>
                        <p className="text-gray-600 leading-relaxed">
                            데이터는 절대 AI 모델 학습에 쓰이지 않습니다. <br />
                            안심하고 사용하세요.
                        </p>
                    </div>
                </div>
                ...
                <div className="relative rounded-3xl bg-[#111] p-8 md:p-12 overflow-hidden text-center text-white">
                    <div className="relative z-10">
                        <h3 className="text-2xl font-bold mb-4">Enterprise 에디션이 필요하신가요?</h3>
