  ...
  const content = language === 'ko' ? {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'HWP/HWPX, PDF, PPTX, DOCX 등을 지원합니다. 다만, 순차적으로 적용될 수 있습니다.'
      },
      {
        question: '결과 출처는 어떻게 제공되나요?',
        answer: 'Localdocs는 모든 결과를 문서 기반으로 제공합니다. 그래서 모든 답변엔 문서 출처 링크 또는 문서 내 위치(페이지, 문단 등)를 결과와 함께 표시합니다. 인용 형식은 데이터 소스에 따라 달라질 수 있습니다.'
      },
      {
        question: '클라우드로 데이터가 전송되나요?',
        answer: '아니요, 데이터는 외부로 전송되지 않습니다. AI가 개인 PC에서 동작하기 때문에 폐쇄망이나 인터넷이 끊겨 있어도 정상 사용할 수 있습니다.'
      },
      {
        question: '기업용 배포 모델이 있나요?',
        answer: '네, Enterprise 플랜을 통해 대규모 팀을 위한 중앙 라이선스 관리 및 폐쇄망 환경을 위한 오프라인 설치/배포를 지원합니다. 별도 문의를 통해 귀사의 환경에 맞는 최적의 솔루션을 상담해 드립니다.'
      },
      {
        question: '한국어 특화 요약 정확도는 어느 정도인가요?',
        answer: '자체 개발한 한국어 특화 온디바이스 LLM을 기반으로, 국내 업무 환경의 보고서, 논문, 법률 문서 등에서 최고의 요약 성능을 목표로 하고 있습니다. 구체적인 성능 지표는 출시와 함께 투명하게 공개할 예정입니다.'
      }
    ]
  } : {
    title: 'FAQ',
