...
const Scenarios = () => <section id="scenarios" className="section" aria-labelledby="scenarios-heading">
    <div className="container">
      ...
      <ul className="grid md:grid-cols-2 gap-4">
        <li className="feature-card relative overflow-hidden" style={{backgroundImage: `url(/lovable-uploads/3098a8d7-6b45-47dc-abc4-9946c5c83a10.png)`, backgroundSize: 'cover', backgroundPosition: 'center'}}><div className="absolute inset-0 bg-white/60 backdrop-blur-sm"></div><div className="relative z-10"><strong>엔터프라이즈 기업</strong><br />수백 페이지의 기술 표준 문서나 R&D 자료에서 필요한 스펙과 정보를 즉시 검색하여 개발 시간을 단축합니다.</div></li>
        <li className="feature-card relative overflow-hidden" style={{backgroundImage: `url(/lovable-uploads/964e7f8b-0bcd-47ff-972d-4595b6bebcd0.png)`, backgroundSize: 'cover', backgroundPosition: 'center'}}><div className="absolute inset-0 bg-white/75 backdrop-blur-sm"></div><div className="relative z-10"><strong>법무법인</strong><br />수만 페이지에 달하는 증거 자료와 판례 더미 속에서 사건의 핵심 쟁점과 인용할 근거를 빠르게 찾아내 소송 전략을 수립합니다.</div></li>
