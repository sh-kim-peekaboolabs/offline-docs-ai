...
const Hero = () => <section className="relative overflow-hidden">
    ...
    <div className="container relative py-20 md:py-28 text-center">
      ...
      <h1 className="mx-auto max-w-3xl text-3xl sm:text-4xl md:text-5xl font-bold leading-normal">인터넷 없이<br />
문서를 요약, 정리, 검색하세요.</h1>
...
const Pricing = () => <section id="pricing" className="section" aria-labelledby="pricing-heading">
    <div className="container pt-6">
      ...
      <div className="grid md:grid-cols-3 gap-6 pt-8" style={{ overflow: 'visible' }}>
