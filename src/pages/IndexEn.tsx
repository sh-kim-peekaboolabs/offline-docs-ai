...
const Solution = () => <section className="section" aria-labelledby="solution-heading">
    <div className="container">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="feature-card flex items-start gap-4"><WifiOff className="text-primary" /><div><h3 className="text-xl font-semibold mb-1">Works locally without internet connection</h3><p className="text-sm text-muted-foreground">Runs entirely on your device, so you can use AI anywhere without internet dependency or connectivity issues.</p></div></div>
        <div className="feature-card flex items-start gap-4"><FileText className="text-primary" /><div><h3 className="text-xl font-semibold mb-1">Support for various file formats</h3><p className="text-sm text-muted-foreground">Instantly analyze PDF, XLSX, PPTX, HWP, and even scanned (OCR) documents without the hassle of conversion.</p></div></div>
        ...
        <div className="feature-card flex items-start gap-4"><LinkIcon className="text-primary" /><div><h3 className="text-xl font-semibold mb-1">Multi-app integration search</h3><p className="text-sm text-muted-foreground">Search across Slack, Notion, Google Drive and other apps in one place to find all relevant information instantly.</p></div></div>
      </div>
