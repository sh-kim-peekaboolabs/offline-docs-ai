      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 p-6 border border-blue-100 hover:shadow-xl transition-all duration-300">
          ...
          <div className="relative">
            ...
            <img src={uploadScreen} alt="File upload screen" className="w-full h-64 object-contain rounded-lg shadow-md mb-4" />
...
Every page is carefully read, with sources provided!</p>
            <img src={qaScreen} alt="Q&A screen" className="w-full h-64 object-contain rounded-lg shadow-md mb-4" />
...
const Features = () => <section id="features" className="section bg-secondary-lighter/50" aria-labelledby="features-heading">
    <div className="container">
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 rounded-full px-4 py-2 bg-accent text-primary text-sm font-medium mb-4">Features</div>
        <h2 id="features-heading" className="text-2xl md:text-3xl font-semibold mb-4">Localdocs is Different</h2>
      </div>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="feature-card bg-white/80 backdrop-blur-sm border border-green-200/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-sm text-muted-foreground">Answers always include 'which document, which page' they came from.</p>
        </div>
        ...
        <div className="feature-card bg-white/80 backdrop-blur-sm border border-indigo-200/50 shadow-lg hover:shadow-xl transition-shadow duration-300 lg:col-span-1">
          ...
          <p className="text-sm text-muted-foreground">Currently supports PDF only. Soon expanding to HWP, PPTX, XLSX.</p>
        </div>
      </div>
    </div>
  </section>;
...
const Security = () => <section id="security" className="section bg-gradient-to-br from-gray-50 to-blue-50/30" aria-labelledby="security-heading">
    <div className="container">
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 rounded-full px-4 py-2 bg-accent text-primary text-sm font-medium mb-4">Security</div>
        <h2 id="security-heading" className="text-2xl md:text-3xl font-semibold mb-4">Your Data Never Leaves Your Computer</h2>
      </div>
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="feature-card bg-white/80 backdrop-blur-sm border border-blue-200/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center gap-3 mb-3">
          ...
          <p className="text-sm text-muted-foreground">All processing is safely done only on your PC. Data is not transmitted externally.</p>
        </div>
        <div className="feature-card bg-white/80 backdrop-blur-sm border border-green-200/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 rounded-lg bg-green-100 text-green-600">
          ...
          <p className="text-sm text-muted-foreground">Not transmitted to external servers, so there's absolutely no risk of leaks.</p>
        </div>
        <div className="feature-card bg-white/80 backdrop-blur-sm border border-purple-200/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 rounded-lg bg-purple-100 text-purple-600">
