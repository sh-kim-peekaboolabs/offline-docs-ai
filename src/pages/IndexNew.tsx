...
const FAQNew = () => {
    const faqs = [
        ...
        },
        {
            ...
            answer: "네, 절대 저장되지 않습니다. 로컬독스는 '하이브리드 보안' 기술을 사용하여, 문서 원본은 PC에 두고 질문에 필요한 텍스트 조각만 암호화하여 프록시 서버로 전송됩니다. 그 누구도 내용을 확인할 수 없습니다."
        },
        {
        ...
        <section id="cta" className="bg-white">
            <div className="max-w-7xl mx-auto border-x border-gray-800 py-20 md:py-32 bg-[#111]">
                <div className="px-8 max-w-xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-white tracking-[-0.02em] mb-4">내 PC에 잠든 지식,<br />지금 깨우세요.</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 items-start">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <a href="/new/en" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                            English
                        </a>
                    </div>
                </div>
